...
if flag == '1':
    os.system(f'medaka_consensus -i {file_path}/medaka/fastx/cluster.fastq -d {file_path}/medaka/fastx/consensus.fasta -o {file_path}/medaka/medaka0 -m r1041_e82_400bps_hac_v5.2.0_rl_lstm384_no_dwells')
    ...
    for i in range(num):
        ...
        os.system(f'medaka_consensus -i {file_path}/medaka/fastx/cluster_{i}.fastq -d {file_path}/medaka/fastx/consensus_{i}.fasta -o {file_path}/medaka/medaka_{i} -m r1041_e82_400bps_hac_v5.2.0_rl_lstm384_no_dwells')
